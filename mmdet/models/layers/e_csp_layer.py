...
from .se_layer import ChannelAttention, SELayer
...
class CSPNeXtBlock(BaseModule):
    """The basic bottleneck block used in Extended-CSPNeXt.
...
class E_CSPNeXtBlock(BaseModule):
    """The basic bottleneck block used in Extended-CSPNeXt.
    ...
    def __init__(self,
        ...
        self.conv1 = conv(
            ...
            norm_cfg=norm_cfg,
            act_cfg=act_cfg)
        self.conv_mainstream = DepthwiseSeparableConvModule(
            hidden_channels,
            out_channels,
            7,
            stride=1,
